...
module render_rasterbars #(
    parameter COORDSPC   = 16,   // signed coordinate width
    ...
    input  wire logic signed [COORDSPC-1:0] beam_y,    // vertical position
  ...
  logic signed [COORDSPC-1:0] sin_data;  // sign extend data to match coords
  sine_table #(
      .ROM_DEPTH(SIN_DEPTH),
      .ROM_WIDTH(SIN_WIDTH),
      .ROM_FILE (SIN_FILE)
  ...
  logic                       bar_drawing_a;
  logic signed [COORDSPC-1:0] bar_y_a;  // screen line to draw at
  logic signed [COORDSPC-1:0] bar_y_a_prev;  // previous line for direction detection
  logic                       bar_up_a;  // bar is moving up the screen?

  rasterbar raster_a (
      .clk,
      .start(beam_y == bar_y_a),
      .line,
  ...
  logic                       bar_drawing_b;
  logic signed [COORDSPC-1:0] bar_y_b;  // screen line to draw at
  logic signed [COORDSPC-1:0] bar_y_b_prev;  // previous line for direction detection
  logic                       bar_up_b;  // bar is moving up the screen?

  rasterbar raster_b (
      .clk,
      .start(beam_y == bar_y_b),
      .line,
  ...
  logic                       bar_drawing_c;
  logic signed [COORDSPC-1:0] bar_y_c;  // screen line to draw at
  logic signed [COORDSPC-1:0] bar_y_c_prev;  // previous line for direction detection
  logic                       bar_up_c;  // bar is moving up the screen?

  rasterbar raster_c (
      .clk,
      .start(beam_y == bar_y_c),
      .line,
  ...
  logic                       bar_drawing_d;
  logic signed [COORDSPC-1:0] bar_y_d;  // screen line to draw at
  logic signed [COORDSPC-1:0] bar_y_d_prev;  // previous line for direction detection
  logic                       bar_up_d;  // bar is moving up the screen?

  rasterbar raster_d (
      .clk,
      .start(beam_y == bar_y_d),
      .line,
