...
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[2]} }];
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[3]} }];
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[4]} }];
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[5]} }];
set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[6]} }];
set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[7]} }];
set_property -dict { PACKAGE_PIN N20   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[8]} }];
set_property -dict { PACKAGE_PIN P20   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[9]} }];
set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[10]} }];
set_property -dict { PACKAGE_PIN U20   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[11]} }];
set_property -dict { PACKAGE_PIN V20   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[12]} }];
set_property -dict { PACKAGE_PIN W20   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[13]} }];
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[14]} }];
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DATA[15]} }];

set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33  } [get_ports { {I2C0_SDA} }];
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33  } [get_ports { {I2C0_SCL} }];

set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33  } [get_ports { {LCD_VSYNC} }];
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33  } [get_ports { {LCD_HSYNC} }];
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33  } [get_ports { {LCD_DE} }];
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33  } [get_ports { {LCD_PCLK} }];
...
# set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33  } [get_ports { {i2c0_sda} }];
# set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33  } [get_ports { {i2co_scl} }];
